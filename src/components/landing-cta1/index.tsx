...
export function FeaturesSectionDemo() {
  const features = [
    ...
    {
      title: "One-Click Deployment to Sonic",
      description:
    ...
    <div className="relative z-20 mx-auto max-w-7xl py-10 lg:py-12">
      <div className="px-8">
        ...
        <div className="mx-auto my-4 max-w-2xl text-center text-sm font-normal text-neutral-500 lg:text-base dark:text-neutral-300">
          Discover how Zed transforms smart contract development with cutting-edge AI features. From seamless code
...
const FeatureCard = ({ children, className }: { children?: React.ReactNode; className?: string }) => {
  return <div className={clsx(`relative overflow-hidden p-4 sm:p-8`, className)}>{children}</div>
}
