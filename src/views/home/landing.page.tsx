...
const words = ["Unlock Smart Contract Innovation", "AI-driven coding  made easy.", "Deploy to Sonic with one click."]
...
const blogContent = [
  {
    ...
    description:
      "Explore how Zed leverages AI to streamline smart contract development. From AI-powered code suggestions to automatic documentation generation, dive into the tools that make smart contract creation faster and more reliable.",
    image: "/mastering.png",
  },
  {
    ...
    description:
      "Learn how Zed's dynamic import resolution feature simplifies multi-file contract compilation and standard imports, making it easier for developers to manage dependencies in their smart contracts.",
    image: "/dynamic.png",
  },
  {
    ...
    description:
      "Security is a top priority in blockchain development. In this article, we explore how Zed's AI-powered code vulnerability checker helps developers catch potential issues early, ensuring safer smart contracts.",
    image: "/security.png",
  },
  {
    date: "10th August, 2023",
    title: "One-Click Deployment to Sonic: How Zed Simplifies Smart Contract Launches",
    description:
      "Deploying smart contracts has never been easier. Learn how Zed integrates one-click deployment and a testnet faucet to simplify the process, getting your contracts live on Sonic in seconds.",
    image: "https://blog.kiiglobal.io/wp-content/uploads/2024/04/safeguarding-the-digital-financial-future.webp",
  },
  {
    date: "5th July, 2023",
    title: "Comprehensive Contract Management with Zed’s Dashboard",
    description:
      "Zed's dashboard allows users to manage and monitor deployed contracts efficiently. In this article, we walk through the features and how you can use them to track, manage, and optimize your smart contracts.",
    image: "/dashboard.png",
  },
]
    ...
    <div className="mx-auto max-w-7xl snap-y snap-mandatory bg-secondary">
            ...
            {isFlipWordsComplete ? (
              <>
                <div className="mx-auto mt-4 max-w-2xl text-center text-base font-normal italic text-neutral-300">
                  Transform smart contract development with Zed. Write, deploy, and manage contracts effortlessly with
                  AI-driven tools and one-click deployment to Sonic's testnet.
                </div>
                <Button
                  type="button"
      ...
      <section className="my-16 snap-center snap-always bg-secondary pt-14">
        ...
        <div className="my-4 pb-4 text-sm font-normal text-neutral-300 lg:text-base dark:text-neutral-300">
          Trusted and modular smart contracts that can be deployed securely on Sonic.
        </div>
        <div className="mx-auto max-w-7xl">
          <CTA3
