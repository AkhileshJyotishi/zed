          ...
          <div className="col-span-3 flex w-full flex-col">
            {!isConnected ? (
              <div className="flex w-full flex-col items-center justify-center">
                <h1 className="text-4xl font-semibold">Welcome to Zed</h1>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Access a variety of tutorials, guides and other educational materials to help you get started with Zed",
                ...
                },
                {
                  ...
                  description:
                    "Find detailed and thorough documentation for Zed, covering all its features and functionalities",
            ...
            >
              <div className="flex items-center justify-between">
                <div className="center w-min gap-2.5 whitespace-nowrap">
                  <a
                    href={`https://testnet.sonicscan.org/tx/${contract.hash}`}
                    target="_blank"
                    rel="noreferrer"
